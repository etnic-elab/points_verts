...
class GoogleMapWidgetState extends State<GoogleMapWidget> {
  ...
  void setWalkIcons() async {
    final Uint8List markerWalkIcon =
        await getBytesFromAsset(getAssetPath("logo"), 70);

    final Uint8List markerCanceledWalkIcon =
        await getBytesFromAsset(getAssetPath("logo-annule"), 70);

    walkIcon = BitmapDescriptor.fromBytes(markerWalkIcon);
    walkCanceledIcon = BitmapDescriptor.fromBytes(markerCanceledWalkIcon);
  }
