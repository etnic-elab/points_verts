...
Future<void> _addTrustedCert(String certPath) async {
  final ByteData data = await Assets.asset.load(certPath);
  final var context = SecurityContext.defaultContext;
  try {
...
Future _deleteData() async {
  ...
  final PackageInfo packageInfo = futures[0];
  final String? lastDataDeleteBuild = futures[1];
