...
class _SettingsState extends State<Settings> {
  ...
  Future<void> _setCrashlyticsEnabled(bool isEnabled) async {
    final var wasEnabled = _crashlyticsEnabled;
      ...
      body: ListView(
        children: <Widget>[
          ...
          SwitchListTile(
            ...
            onChanged: _setCrashlyticsEnabled,
          ),
          const Divider(),
          ListTile(
